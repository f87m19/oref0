...
curl -s https://raw.githubusercontent.com/f87m19/oref0/v063/bin/openaps-packages.sh | bash -
mkdir -p ~/src; cd ~/src && git clone git://github.com/f87m19/oref0.git || (cd oref0 && git checkout v063 && git pull)
